...
void showRuleBook()
{
    ...
    gotoxy(5, 3);
    cout << "2. The snake moves in the direction you press.";
    gotoxy(5, 4);
    cout << "3. Eat the food '*' to grow and earn points.";
    gotoxy(5, 5);
    cout << "4. Avoid hitting the walls or your own body.";
    gotoxy(5, 6);
    cout << "5. Each level increases the difficulty with more obstacles.";
    gotoxy(5, 7);
    cout << "6. Press any key to start playing the game.";
    gotoxy(5, 8);
    cout << "=======================================================";
    getch();
}
